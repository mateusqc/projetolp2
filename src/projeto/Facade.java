...
public class Facade {
	...
	/**
	 * Método que cadastra um novo Aluno no sistema. Utiliza o método
	 * {@link AlunoController#cadastrarAluno(String, String, int, String, String)}
	...
	/**
	 * Método que gera uma listagem de todos os Alunos cadastrados no sistema
	 * ordenados por ordem alfabética pelo nome. Utiliza o método
	 * {@link AlunoController#listarAlunos()} da classe {@link AlunoController}.
	 * 
	...
	/**
	 * Método que torna um Aluno em Tutor. Utiliza os métodos
	 * {@link TutorController#tornarTutor(String, String, int, Aluno)} da classe
	 * {@link TutorController} e {@link AlunoController#tornarTutor(String)} da
	...
	public void tornarTutor(String matricula, String disciplina, int proficiencia) {
		this.tutorController.tornarTutor(matricula, disciplina, proficiencia,
				this.alunoController.tornarTutor(matricula));
	}
	...
	/**
	 * Método que recebe os parametros necessários e realiza cadastro do local de
